...
<div class="modal fade" id="ChangePicture" data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLiveLabel">Change Picture</h5>
          <button class="btn-close" type="button" data-coreui-dismiss="modal" aria-label="Close"></button>
        </div>
        <?=form_open_multipart(base_url()."change_picture");?>
        <input type="hidden" name="customer_no" value="<?=$profile['customer_no'];?>">
      <div class="modal-body">
        <div class="mb-4">
          <label class="col-form-label">Select Picture</label>
