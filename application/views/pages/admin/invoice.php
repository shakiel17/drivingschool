...
<center>
    <div style="width:876px;">
        <table width="100%" border="0" style="font-family:Arial;">
            <tr>
                <td colspan="3"><h3>INVOICE # <?=$invno;?> <br>Flores 1 on 1 Driving Tutorial <br><small style="font-size:14px;">Roxas St., Kidapawan City</small></h3></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="3"><h3>INVOICE DETAILS</h3></td>
            </tr>           
        </table>
        ...
        <table width="100%" border="0">
            <tr>                
                <td><b>Total Amount Paid: <?=number_format($item['amount'],2);?></b></td>
            </tr>
        </table>
        <br><br>
        <br><br>
